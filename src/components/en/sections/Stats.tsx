...
const stats = [
  {
    ...
    description: "No weekends or vacations",
  },
  {
    icon: <Rocket size={34} />,
    value: 7,
  ...
  },
  {
    ...
    description: "Built around your business needs",
  },
  {
    icon: <Clock3 size={34} />,
    value: 4,
        ...
        <div className="relative mx-auto max-w-7xl px-6">
          <div className="mx-auto max-w-3xl text-center">
            <span className="inline-flex rounded-full border border-blue-500/30 bg-blue-500/10 px-5 py-2 text-sm font-medium text-blue-400">
              FlowForge in Numbers
            </span>

            <h2 className="mt-8 text-4xl font-extrabold md:text-5xl">
              Results you can
              <span className="text-blue-500"> measure</span>
            </h2>

            <p className="mx-auto mt-6 max-w-2xl text-lg leading-8 text-zinc-400">
              We build AI systems that save time, automate routine work
              and help businesses operate faster.
            </p>
          </div>
