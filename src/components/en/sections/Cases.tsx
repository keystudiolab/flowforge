...
export default function Cases() {
  const cases = [
    {
      icon: <Bot size={42} />,
      title: "AI Consultant for Telegram",
      description:
        "AI answers customers 24/7, qualifies incoming requests and sends only high-intent leads to the manager.",
      result: "+80% of inquiries handled automatically",
    ...
    },
    {
      ...
      description:
        "CRM, AI and Telegram are connected into one customer management system.",
      result: "−70% less time spent processing leads",
      stack: ["CRM", "AI", "API"],
    },
    {
      icon: <Brain size={42} />,
      ...
      description:
        "AI helps customers choose products, answers questions and assists with placing orders.",
      result: "+37% increase in conversion",
        ...
        <div className="relative mx-auto max-w-7xl px-6">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mx-auto mt-8 max-w-2xl text-lg leading-8 text-zinc-400">
              We build AI systems that reduce manual work, increase sales and
              help businesses operate faster.
            </p>
          </div>
