        ...
        <div className="relative mx-auto max-w-7xl px-6">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <h2 className="mt-8 text-5xl font-extrabold leading-tight">
              Why companies
              <br />
              choose <span className="text-blue-500">FlowForge</span>
            </h2>

            <p className="mx-auto mt-8 max-w-2xl text-lg leading-8 text-zinc-400">
              We build AI solutions that launch quickly, deliver measurable
              value and continue helping businesses every day.
            </p>
          </div>
          ...
          <div className="mt-20 grid gap-8 md:grid-cols-2 xl:grid-cols-4">
            <div className="group rounded-3xl border border-zinc-800 bg-zinc-900/60 p-8 backdrop-blur-xl transition duration-300 hover:-translate-y-2 hover:border-blue-500">
              ...
              <p className="mt-5 leading-8 text-zinc-400">
                Most projects can be launched in less than two weeks.
              </p>
            </div>
            ...
            <div className="group rounded-3xl border border-zinc-800 bg-zinc-900/60 p-8 backdrop-blur-xl transition duration-300 hover:-translate-y-2 hover:border-blue-500">
              ...
              <p className="mt-5 leading-8 text-zinc-400">
                Automation frees your employees from repetitive daily work.
              </p>
            </div>
            ...
            <div className="group rounded-3xl border border-zinc-800 bg-zinc-900/60 p-8 backdrop-blur-xl transition duration-300 hover:-translate-y-2 hover:border-blue-500">
              ...
              <p className="mt-5 leading-8 text-zinc-400">
                We use modern AI models, secure integrations and proven
                architecture.
              </p>
            </div>
            ...
            <div className="group rounded-3xl border border-zinc-800 bg-zinc-900/60 p-8 backdrop-blur-xl transition duration-300 hover:-translate-y-2 hover:border-blue-500">
              ...
              <p className="mt-5 leading-8 text-zinc-400">
                AI helps improve operational speed, customer service and
                business revenue.
              </p>
            </div>
          </div>
